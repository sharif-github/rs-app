  ...
  <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">{{ $user_status }} Vehicle Panel</h1>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <form action="{{ route('vehicle.registrationPanel') }}" method="GET">
                            <div class="col ">
                                <input type="search" id="car_query" name="car_query" value="{{ request()->query('hosptial_query') }}" class="form-control" style="border-color: #A5CE8B;" placeholder="Search car" autocomplete="off"/>
                            </div>
                ...
                @forelse($vehicle_list as $vehicle)
                        ...
                        <div class="col-xl-6 col-md-6 mb-4" >
                            <div class="card border-left-primary shadow h-100" >
                                    ...
                                    <div class="row">
                                         <div class="col-4">
                                            <img src="{{ asset($vehicle->main_image) }}" class="img-fluid rounded-start" alt="Toyota Hiace 2007">
                                        </div>
